...
public:
    ...
    {
        SearchDlg->setWindowTitle(QApplication::translate("SearchDlg", "Search for help", Q_NULLPTR));
        label_2->setText(QApplication::translate("SearchDlg", "API", Q_NULLPTR));
        label->setText(QApplication::translate("SearchDlg", "Question", Q_NULLPTR));
    } // retranslateUi
