...
QT_MOC_LITERAL(1, 7, 14), // "closeOtherTabs"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 5), // "index"
QT_MOC_LITERAL(4, 29, 12), // "closeAllTabs"
QT_MOC_LITERAL(5, 42, 9), // "reloadTab"
QT_MOC_LITERAL(6, 52, 13), // "reloadAllTabs"
QT_MOC_LITERAL(7, 66, 10), // "onCloseTab"
QT_MOC_LITERAL(8, 77, 16), // "onCloseOtherTabs"
QT_MOC_LITERAL(9, 94, 11) // "onReloadTab"

    },
    "TabBar\0closeOtherTabs\0\0index\0closeAllTabs\0"
    "reloadTab\0reloadAllTabs\0onCloseTab\0"
    "onCloseOtherTabs\0onReloadTab"
};
...
void TabBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->closeOtherTabs((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->closeAllTabs(); break;
        case 2: _t->reloadTab((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->reloadAllTabs(); break;
        case 4: _t->onCloseTab(); break;
        case 5: _t->onCloseOtherTabs(); break;
        case 6: _t->onReloadTab(); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TabBar::closeAllTabs)) {
                *result = 1;
            }
        }
        {
